<div>
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Request Cetak Ulang Struk</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 max-w-lg">
        <h2 class="font-semibold text-gray-700 mb-3">Buat Request Baru</h2>
        <div class="space-y-3">
            <div>
            ...
            <div>
                ...
                <textarea wire:model="reason" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" placeholder="Mengapa perlu cetak ulang?"></textarea>
                @error('reason') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <button wire:click="requestReprint" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">Kirim Request</button>
        </div>
    </div>
