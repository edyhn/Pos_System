    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form wire:submit="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" wire:model="price" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('price') border-red-500 @enderror">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">Rp</span>
                        <input type="number" wire:model="cost_price" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Trigger auto PO saat stok di bawah ini</p>
                </div>
                <div>
            ...
            <div class="mb-4">
                ...
                @if ($image)
                    <div class="mt-2">
                        <img src="{{ $image->temporaryUrl() }}" class="h-32 object-contain border rounded-lg">
                    </div>
                @elseif($isEdit && $existingImage)
                    <div class="mt-2">
                        <img src="{{ Storage::url($existingImage) }}" class="h-32 object-contain border rounded-lg">
                    </div>
                @endif
