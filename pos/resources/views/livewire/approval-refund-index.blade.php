                        ...
                        <tr class="hover:bg-gray-50 text-sm transition">
                            ...
                            <td class="px-4 py-3.5 text-right">
                                @if($req->status == 'pending')
                                    <button wire:click="showForm({{ $req->id }}, {{ $req->refund_amount ?? 0 }})" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
